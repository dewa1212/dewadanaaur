...
function openModal(imgElement) {
  ...
  // **MODIFIED: Penanganan tampilan modal lebih langsung**
...
function closeModal() {
  ...
  // **MODIFIED: Penanganan sembunyikan modal lebih langsung**
  modal.style.display = "none";
  modal.style.opacity = "0";
  modal.style.visibility = "hidden";
  document.body.style.overflow = "auto";
  console.log("Modal display style set to none:", modal.style.display);
  console.log("Modal opacity set to 0:", modal.style.opacity);
  console.log("Modal visibility set to hidden:", modal.style.visibility);
